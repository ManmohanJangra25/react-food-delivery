...
const Login = () => {
  ...
  const loaderDots = <img width="10%" src="https://media.tenor.com/NqKNFHSmbssAAAAi/discord-loading-dots-discord-loading.gif" alt="loading"/>;
      ...
      <div className="loginForm">
        <Form method="post">
          ...
          {!isSubmitting && data && data.message && (
            <p className="error_message">{data.message}</p>
          )}
          <button className="auth_btn">
            {isSubmitting ? loaderDots : "Sign In"}
          </button>
        </Form>
        <div>
